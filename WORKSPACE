new_git_repository(
    name = "com_github_boost_accumulators",
    build_file = "boost_accumulators.BUILD",
    commit = "5c1ed6a5dfddebebee8332b03d979f8022218199",
...
new_git_repository(
    ...
    build_file = "boost_filesystem.BUILD",
...
new_git_repository(
    ...
    build_file = "boost_function.BUILD",
...
new_git_repository(
    ...
    build_file = "boost_interprocess.BUILD",
...
new_git_repository(
    ...
    build_file = "boost_optional.BUILD",
...
new_git_repository(
    ...
    build_file = "boost_parameter.BUILD",
...
new_git_repository(
    ...
    build_file = "boost_process.BUILD",
...
new_git_repository(
    ...
    build_file = "boost_tokenizer.BUILD",
...
new_git_repository(
    ...
    build_file = "boost_type_index.BUILD",
